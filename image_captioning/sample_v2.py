...
from model_v2 import EncoderCNN, DecoderRNN, AttnEncoder, AttnDecoderRNN, ResidualBlock
...
def main(args):
    ...
    sampled_ids = decoder.sample(feature,args.embed_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='./models/encoder_v2-96-1400.pkl',
                        help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='./models/decoder_v2-96-1400.pkl',
